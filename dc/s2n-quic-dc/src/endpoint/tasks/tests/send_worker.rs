...
fn send_ack_processor_ignores_invalid_sender_id() {
    ...
    sim(|| {
        ...
        let socket_immediate_txs: crate::endpoint::id::IdMap<crate::endpoint::id::LocalSendSocketId, _> =
            core::iter::once((crate::endpoint::id::LocalSendSocketId::new(0), immediate_tx_raw)).collect();
        let mut sender_idx_to_local_imm = crate::endpoint::id::IdMap::<
            crate::endpoint::id::LocalSenderId,
            crate::endpoint::id::LocalSendSocketId,
        >::new(1, crate::endpoint::id::LocalSendSocketId::new(0));
        sender_idx_to_local_imm[crate::endpoint::id::LocalSenderId::from_index(0)] = crate::endpoint::id::LocalSendSocketId::new(0);
...
fn send_pto_timeout_routes_pending_context_to_tx_wheel() {
    ...
    sim(|| {
        ...
        let (pto_immediate_tx_raw, _pto_immediate_rx) = unsync::new_with_adapter::<send::TxImmediateAdapter>();
        let pto_socket_immediate_txs: crate::endpoint::id::IdMap<crate::endpoint::id::LocalSendSocketId, _> =
            core::iter::once((crate::endpoint::id::LocalSendSocketId::new(0), pto_immediate_tx_raw)).collect();
        let mut pto_sender_idx_to_local = crate::endpoint::id::IdMap::<
            crate::endpoint::id::LocalSenderId,
            crate::endpoint::id::LocalSendSocketId,
        >::new(1, crate::endpoint::id::LocalSendSocketId::new(0));
        pto_sender_idx_to_local[crate::endpoint::id::LocalSenderId::from_index(0)] = crate::endpoint::id::LocalSendSocketId::new(0);
        let pto_immediate_tx = send::ImmediateSender::new(pto_socket_immediate_txs, pto_sender_idx_to_local);
