...
pub struct Context<R: Recorder> {
    ...
    stream_max_data_transmitted: AtomicU64,
    ...
    S::ConnectionContext: Recorder,
{
    ...
    fn on_stream_max_data_transmitted(
        ...
        context
            ...
            .fetch_add(1, Ordering::Relaxed);
        self.subscriber
            .on_stream_max_data_transmitted(&context.recorder, meta, event);
    }
    #[inline]
...
impl<R: Recorder> Drop for Context<R> {
    fn drop(&mut self) {
        ...
        self.recorder.increment_counter(
            "stream_max_data_transmitted",
            self.stream_max_data_transmitted.load(Ordering::Relaxed) as _,
        );
        self.recorder.increment_counter(
            "stream_control_packet_transmitted",
