...
impl<R: Registry> Subscriber<R> {
    ...
    pub fn new(registry: R) -> Self {
        ...
        counters.push(registry.register_counter(&INFO[335usize]));
        counters.push(registry.register_counter(&INFO[338usize]));
        ...
        bool_counters.push(registry.register_bool_counter(&INFO[310usize]));
        bool_counters.push(registry.register_bool_counter(&INFO[315usize]));
        {
        ...
        measures.push(registry.register_measure(&INFO[257usize]));
    ...
    pub fn counters(&self) -> impl Iterator<Item = (&'static Info, &R::Counter)> + '_ {
        self.counters
            ...
            .map(|(idx, entry)| match idx {
                ...
                71usize => (&INFO[213usize], entry),
                72usize => (&INFO[218usize], entry),
                73usize => (&INFO[223usize], entry),
                74usize => (&INFO[229usize], entry),
                75usize => (&INFO[236usize], entry),
                76usize => (&INFO[241usize], entry),
                77usize => (&INFO[246usize], entry),
                78usize => (&INFO[251usize], entry),
                79usize => (&INFO[252usize], entry),
                80usize => (&INFO[254usize], entry),
                81usize => (&INFO[258usize], entry),
                82usize => (&INFO[260usize], entry),
                83usize => (&INFO[262usize], entry),
                84usize => (&INFO[264usize], entry),
                85usize => (&INFO[266usize], entry),
                86usize => (&INFO[269usize], entry),
                87usize => (&INFO[272usize], entry),
                88usize => (&INFO[274usize], entry),
                89usize => (&INFO[276usize], entry),
                90usize => (&INFO[278usize], entry),
                91usize => (&INFO[280usize], entry),
                92usize => (&INFO[282usize], entry),
                93usize => (&INFO[285usize], entry),
                94usize => (&INFO[286usize], entry),
                95usize => (&INFO[288usize], entry),
                96usize => (&INFO[290usize], entry),
                97usize => (&INFO[292usize], entry),
                98usize => (&INFO[294usize], entry),
                99usize => (&INFO[296usize], entry),
                100usize => (&INFO[298usize], entry),
                101usize => (&INFO[300usize], entry),
                102usize => (&INFO[302usize], entry),
                103usize => (&INFO[304usize], entry),
                104usize => (&INFO[306usize], entry),
                105usize => (&INFO[308usize], entry),
                106usize => (&INFO[311usize], entry),
                107usize => (&INFO[314usize], entry),
                108usize => (&INFO[316usize], entry),
                109usize => (&INFO[318usize], entry),
                110usize => (&INFO[335usize], entry),
                111usize => (&INFO[338usize], entry),
    ...
    pub fn bool_counters(&self) -> impl Iterator<Item = (&'static Info, &R::BoolCounter)> + '_ {
        self.bool_counters
            ...
            .map(|(idx, entry)| match idx {
                ...
                19usize => (&INFO[217usize], entry),
                20usize => (&INFO[310usize], entry),
                21usize => (&INFO[315usize], entry),
                _ => unsafe { core::hint::unreachable_unchecked() },
            })
    }
    #[allow(dead_code)]
    ...
    pub fn measures(&self) -> impl Iterator<Item = (&'static Info, &R::Measure)> + '_ {
        self.measures
            ...
            .map(|(idx, entry)| match idx {
                ...
                93usize => (&INFO[204usize], entry),
                94usize => (&INFO[205usize], entry),
                95usize => (&INFO[207usize], entry),
                96usize => (&INFO[208usize], entry),
                97usize => (&INFO[220usize], entry),
                98usize => (&INFO[221usize], entry),
                99usize => (&INFO[222usize], entry),
                100usize => (&INFO[225usize], entry),
                101usize => (&INFO[226usize], entry),
                102usize => (&INFO[227usize], entry),
                103usize => (&INFO[228usize], entry),
                104usize => (&INFO[231usize], entry),
                105usize => (&INFO[232usize], entry),
                106usize => (&INFO[233usize], entry),
                107usize => (&INFO[234usize], entry),
                108usize => (&INFO[235usize], entry),
                109usize => (&INFO[238usize], entry),
                110usize => (&INFO[239usize], entry),
                111usize => (&INFO[240usize], entry),
                112usize => (&INFO[243usize], entry),
                113usize => (&INFO[244usize], entry),
                114usize => (&INFO[245usize], entry),
                115usize => (&INFO[248usize], entry),
                116usize => (&INFO[249usize], entry),
                117usize => (&INFO[250usize], entry),
                118usize => (&INFO[253usize], entry),
                119usize => (&INFO[255usize], entry),
                120usize => (&INFO[256usize], entry),
                121usize => (&INFO[257usize], entry),
                122usize => (&INFO[268usize], entry),
                123usize => (&INFO[271usize], entry),
                124usize => (&INFO[283usize], entry),
                125usize => (&INFO[284usize], entry),
                126usize => (&INFO[287usize], entry),
                127usize => (&INFO[313usize], entry),
                128usize => (&INFO[317usize], entry),
                129usize => (&INFO[319usize], entry),
                130usize => (&INFO[320usize], entry),
                131usize => (&INFO[321usize], entry),
                132usize => (&INFO[322usize], entry),
                133usize => (&INFO[323usize], entry),
                134usize => (&INFO[324usize], entry),
                135usize => (&INFO[325usize], entry),
                136usize => (&INFO[326usize], entry),
                137usize => (&INFO[327usize], entry),
                138usize => (&INFO[328usize], entry),
                139usize => (&INFO[329usize], entry),
                140usize => (&INFO[330usize], entry),
                141usize => (&INFO[331usize], entry),
                142usize => (&INFO[332usize], entry),
                143usize => (&INFO[333usize], entry),
                144usize => (&INFO[334usize], entry),
                145usize => (&INFO[336usize], entry),
                146usize => (&INFO[337usize], entry),
                147usize => (&INFO[339usize], entry),
                148usize => (&INFO[340usize], entry),
                _ => unsafe { core::hint::unreachable_unchecked() },
            })
    }
    #[allow(dead_code)]
...
impl<R: Registry> event::Subscriber for Subscriber<R> {
    ...
    fn on_stream_control_packet_transmitted(
        ...
        self.measure(204usize, 93usize, event.packet_len);
        self.measure(205usize, 94usize, event.control_data_len);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_control_packet_received(
        ...
        self.measure(207usize, 95usize, event.packet_len);
        self.measure(208usize, 96usize, event.control_data_len);
        self.count_bool(209usize, 17usize, event.is_authenticated);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_endpoint_initialized(&self, meta: &api::EndpointMeta, event: &api::EndpointInitialized) {
        #[allow(unused_imports)]
        use api::*;
        self.count(213usize, 71usize, 1usize);
        self.count_nominal(214usize, 7usize, &event.acceptor_addr);
        self.count_nominal(215usize, 8usize, &event.handshake_addr);
        self.count_bool(216usize, 18usize, event.tcp);
        self.count_bool(217usize, 19usize, event.udp);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_udp_immediate_transmission_scheduled(
        ...
        self.count_nominal(219usize, 9usize, &event.peer_address);
        self.measure(220usize, 97usize, event.buffer_size);
        self.measure(221usize, 98usize, event.segment_size);
        self.measure(222usize, 99usize, event.segment_count);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_udp_transmission_scheduled(
        ...
        self.count_nominal(224usize, 10usize, &event.peer_address);
        self.measure(225usize, 100usize, event.buffer_size);
        self.measure(226usize, 101usize, event.segment_size);
        self.measure(227usize, 102usize, event.segment_count);
        self.measure(228usize, 103usize, event.delay);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_udp_transmission_rejected(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(229usize, 74usize, 1usize);
        self.count_nominal(230usize, 11usize, &event.peer_address);
        self.measure(231usize, 104usize, event.buffer_size);
        self.measure(232usize, 105usize, event.segment_size);
        self.measure(233usize, 106usize, event.segment_count);
        self.measure(234usize, 107usize, event.delay);
        self.measure(235usize, 108usize, event.backoff);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_udp_packet_transmitted(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(236usize, 75usize, 1usize);
        self.count_nominal(237usize, 12usize, &event.peer_address);
        self.measure(238usize, 109usize, event.buffer_size);
        self.measure(239usize, 110usize, event.segment_size);
        self.measure(240usize, 111usize, event.segment_count);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_udp_transmit_errored(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(241usize, 76usize, 1usize);
        self.count_nominal(242usize, 13usize, &event.peer_address);
        self.measure(243usize, 112usize, event.buffer_size);
        self.measure(244usize, 113usize, event.segment_size);
        self.measure(245usize, 114usize, event.segment_count);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_udp_packet_received(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(246usize, 77usize, 1usize);
        self.count_nominal(247usize, 14usize, &event.peer_address);
        self.measure(248usize, 115usize, event.buffer_size);
        self.measure(249usize, 116usize, event.segment_size);
        self.measure(250usize, 117usize, event.segment_count);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    ...
    fn on_path_secret_map_initialized(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(252usize, 79usize, 1usize);
        self.measure(253usize, 118usize, event.capacity);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_uninitialized(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(254usize, 80usize, 1usize);
        self.measure(255usize, 119usize, event.capacity);
        self.measure(256usize, 120usize, event.entries);
        self.measure(257usize, 121usize, event.lifetime);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_background_handshake_requested(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(258usize, 81usize, 1usize);
        self.count_nominal(259usize, 15usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_entry_inserted(
        ...
        self.count_nominal(261usize, 16usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_entry_ready(
        ...
        self.count_nominal(263usize, 17usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_entry_replaced(
        ...
        self.count_nominal(265usize, 18usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_id_entry_evicted(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(266usize, 85usize, 1usize);
        self.count_nominal(267usize, 19usize, &event.peer_address);
        self.measure(268usize, 122usize, event.age);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_address_entry_evicted(
        ...
        self.count_nominal(270usize, 20usize, &event.peer_address);
        self.measure(271usize, 123usize, event.age);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_unknown_path_secret_packet_sent(
        ...
        self.count_nominal(273usize, 21usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_unknown_path_secret_packet_received(
        ...
        self.count_nominal(275usize, 22usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_unknown_path_secret_packet_accepted(
        ...
        self.count_nominal(277usize, 23usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_unknown_path_secret_packet_rejected(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(278usize, 90usize, 1usize);
        self.count_nominal(279usize, 24usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_unknown_path_secret_packet_dropped(
        ...
        self.count_nominal(281usize, 25usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_key_accepted(&self, meta: &api::EndpointMeta, event: &api::KeyAccepted) {
        #[allow(unused_imports)]
        use api::*;
        self.count(282usize, 92usize, 1usize);
        self.measure(283usize, 124usize, event.gap);
        self.measure(284usize, 125usize, event.forward_shift);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    ...
    fn on_replay_potentially_detected(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(286usize, 94usize, 1usize);
        self.measure(287usize, 126usize, event.gap);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_detected_packet_sent(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(288usize, 95usize, 1usize);
    ...
    fn on_replay_detected_packet_received(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(290usize, 96usize, 1usize);
    ...
    fn on_replay_detected_packet_accepted(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(292usize, 97usize, 1usize);
        self.count_nominal(293usize, 28usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_detected_packet_rejected(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(294usize, 98usize, 1usize);
        self.count_nominal(295usize, 29usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_detected_packet_dropped(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(296usize, 99usize, 1usize);
        self.count_nominal(297usize, 30usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_sent(&self, meta: &api::EndpointMeta, event: &api::StaleKeyPacketSent) {
        #[allow(unused_imports)]
        use api::*;
        self.count(298usize, 100usize, 1usize);
        self.count_nominal(299usize, 31usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_received(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(300usize, 101usize, 1usize);
        self.count_nominal(301usize, 32usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_accepted(
        ...
        self.count_nominal(303usize, 33usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_rejected(
        ...
        self.count_nominal(305usize, 34usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_dropped(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(306usize, 104usize, 1usize);
        self.count_nominal(307usize, 35usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_address_cache_accessed(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(308usize, 105usize, 1usize);
        self.count_nominal(309usize, 36usize, &event.peer_address);
        self.count_bool(310usize, 20usize, event.hit);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_address_cache_accessed_hit(
        ...
        self.count_nominal(312usize, 37usize, &event.peer_address);
        self.measure(313usize, 127usize, event.age);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_id_cache_accessed(
        ...
        self.count_bool(315usize, 21usize, event.hit);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_id_cache_accessed_hit(
        ...
        self.measure(317usize, 128usize, event.age);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_cleaner_cycled(
        ...
        self.measure(319usize, 129usize, event.id_entries);
        self.measure(320usize, 130usize, event.id_entries_retired);
        self.measure(321usize, 131usize, event.id_entries_active);
        self.measure(322usize, 132usize, event.id_entries_active_utilization);
        self.measure(323usize, 133usize, event.id_entries_utilization);
        self.measure(324usize, 134usize, event.id_entries_initial_utilization);
        self.measure(325usize, 135usize, event.address_entries);
        self.measure(326usize, 136usize, event.address_entries_active);
        self.measure(327usize, 137usize, event.address_entries_active_utilization);
        self.measure(328usize, 138usize, event.address_entries_retired);
        self.measure(329usize, 139usize, event.address_entries_utilization);
        self.measure(
            330usize,
            140usize,
            event.address_entries_initial_utilization,
        );
        self.measure(331usize, 141usize, event.handshake_requests);
        self.measure(332usize, 142usize, event.handshake_requests_retired);
        self.measure(333usize, 143usize, event.handshake_lock_duration);
        self.measure(334usize, 144usize, event.duration);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_id_write_lock(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(335usize, 110usize, 1usize);
        self.measure(336usize, 145usize, event.acquire);
        self.measure(337usize, 146usize, event.duration);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_address_write_lock(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(338usize, 111usize, 1usize);
        self.measure(339usize, 147usize, event.acquire);
        self.measure(340usize, 148usize, event.duration);
        let _ = event;
        let _ = meta;
    }
}
