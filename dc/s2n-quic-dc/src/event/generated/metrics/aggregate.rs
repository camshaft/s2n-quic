...
static INFO: &[Info; 340usize] = &[
    ...
    info::Builder {
        id: 201usize,
        name: Str::new("stream_max_data_transmitted\0"),
        units: Units::None,
    }
    .build(),
    info::Builder {
...
impl<R: Registry> Subscriber<R> {
    ...
    pub fn new(registry: R) -> Self {
        ...
        counters.push(registry.register_counter(&INFO[334usize]));
        counters.push(registry.register_counter(&INFO[337usize]));
        ...
        bool_counters.push(registry.register_bool_counter(&INFO[309usize]));
        bool_counters.push(registry.register_bool_counter(&INFO[314usize]));
        {
            ...
            }
            {
                ...
                for variant in <SocketAddress as AsVariant>::VARIANTS.iter() {
                    nominal_counters
                        .push(registry.register_nominal_counter(&INFO[294usize], variant));
                    count += 1;
                }
                debug_assert_ne!(count, 0, "field type needs at least one variant");
                nominal_counter_offsets.push(offset);
            }
            {
                ...
                for variant in <SocketAddress as AsVariant>::VARIANTS.iter() {
                    nominal_counters
                        .push(registry.register_nominal_counter(&INFO[296usize], variant));
                    count += 1;
                }
                debug_assert_ne!(count, 0, "field type needs at least one variant");
                nominal_counter_offsets.push(offset);
            }
            {
                ...
                for variant in <SocketAddress as AsVariant>::VARIANTS.iter() {
                    nominal_counters
                        .push(registry.register_nominal_counter(&INFO[298usize], variant));
                    count += 1;
                }
                debug_assert_ne!(count, 0, "field type needs at least one variant");
                nominal_counter_offsets.push(offset);
        ...
        measures.push(registry.register_measure(&INFO[312usize]));
        measures.push(registry.register_measure(&INFO[316usize]));
    ...
    pub fn counters(&self) -> impl Iterator<Item = (&'static Info, &R::Counter)> + '_ {
        self.counters
            ...
            .map(|(idx, entry)| match idx {
                ...
                72usize => (&INFO[222usize], entry),
                73usize => (&INFO[228usize], entry),
                74usize => (&INFO[235usize], entry),
                75usize => (&INFO[240usize], entry),
                76usize => (&INFO[245usize], entry),
                77usize => (&INFO[250usize], entry),
                78usize => (&INFO[251usize], entry),
                79usize => (&INFO[253usize], entry),
                80usize => (&INFO[257usize], entry),
                81usize => (&INFO[259usize], entry),
                82usize => (&INFO[261usize], entry),
                83usize => (&INFO[263usize], entry),
                84usize => (&INFO[265usize], entry),
                85usize => (&INFO[268usize], entry),
                86usize => (&INFO[271usize], entry),
                87usize => (&INFO[273usize], entry),
                88usize => (&INFO[275usize], entry),
                89usize => (&INFO[277usize], entry),
                90usize => (&INFO[279usize], entry),
                91usize => (&INFO[281usize], entry),
                ...
                106usize => (&INFO[313usize], entry),
                107usize => (&INFO[315usize], entry),
                108usize => (&INFO[317usize], entry),
                109usize => (&INFO[334usize], entry),
                110usize => (&INFO[337usize], entry),
    ...
    pub fn bool_counters(&self) -> impl Iterator<Item = (&'static Info, &R::BoolCounter)> + '_ {
        self.bool_counters
            ...
            .map(|(idx, entry)| match idx {
                ...
                18usize => (&INFO[215usize], entry),
                19usize => (&INFO[216usize], entry),
                20usize => (&INFO[309usize], entry),
                21usize => (&INFO[314usize], entry),
                _ => unsafe { core::hint::unreachable_unchecked() },
            })
    }
    #[allow(dead_code)]
        ...
        self.nominal_counter_offsets
            ...
            .map(|(idx, entry)| match idx {
                ...
                29usize => {
                    ...
                    let variants = <SocketAddress as AsVariant>::VARIANTS;
                    let entries = &self.nominal_counters[offset..offset + variants.len()];
                    (&INFO[294usize], entries, variants)
                }
                30usize => {
                    let offset = *entry;
                    let variants = <SocketAddress as AsVariant>::VARIANTS;
                    let entries = &self.nominal_counters[offset..offset + variants.len()];
                    (&INFO[296usize], entries, variants)
                }
                31usize => {
                    let offset = *entry;
                    let variants = <SocketAddress as AsVariant>::VARIANTS;
                    let entries = &self.nominal_counters[offset..offset + variants.len()];
                    (&INFO[298usize], entries, variants)
                }
                32usize => {
                    let offset = *entry;
                    let variants = <SocketAddress as AsVariant>::VARIANTS;
    ...
    pub fn measures(&self) -> impl Iterator<Item = (&'static Info, &R::Measure)> + '_ {
        self.measures
            ...
            .map(|(idx, entry)| match idx {
                ...
                93usize => (&INFO[203usize], entry),
                94usize => (&INFO[204usize], entry),
                95usize => (&INFO[206usize], entry),
                96usize => (&INFO[207usize], entry),
                97usize => (&INFO[219usize], entry),
                98usize => (&INFO[220usize], entry),
                99usize => (&INFO[221usize], entry),
                100usize => (&INFO[224usize], entry),
                101usize => (&INFO[225usize], entry),
                102usize => (&INFO[226usize], entry),
                103usize => (&INFO[227usize], entry),
                104usize => (&INFO[230usize], entry),
                105usize => (&INFO[231usize], entry),
                106usize => (&INFO[232usize], entry),
                107usize => (&INFO[233usize], entry),
                108usize => (&INFO[234usize], entry),
                109usize => (&INFO[237usize], entry),
                110usize => (&INFO[238usize], entry),
                111usize => (&INFO[239usize], entry),
                112usize => (&INFO[242usize], entry),
                113usize => (&INFO[243usize], entry),
                114usize => (&INFO[244usize], entry),
                115usize => (&INFO[247usize], entry),
                116usize => (&INFO[248usize], entry),
                117usize => (&INFO[249usize], entry),
                118usize => (&INFO[252usize], entry),
                119usize => (&INFO[254usize], entry),
                120usize => (&INFO[255usize], entry),
                121usize => (&INFO[256usize], entry),
                122usize => (&INFO[267usize], entry),
                123usize => (&INFO[270usize], entry),
                124usize => (&INFO[282usize], entry),
                125usize => (&INFO[283usize], entry),
                126usize => (&INFO[286usize], entry),
                127usize => (&INFO[312usize], entry),
                128usize => (&INFO[316usize], entry),
                129usize => (&INFO[318usize], entry),
                130usize => (&INFO[319usize], entry),
                131usize => (&INFO[320usize], entry),
                132usize => (&INFO[321usize], entry),
                133usize => (&INFO[322usize], entry),
                134usize => (&INFO[323usize], entry),
                135usize => (&INFO[324usize], entry),
                136usize => (&INFO[325usize], entry),
                137usize => (&INFO[326usize], entry),
                138usize => (&INFO[327usize], entry),
                139usize => (&INFO[328usize], entry),
                140usize => (&INFO[329usize], entry),
                141usize => (&INFO[330usize], entry),
                142usize => (&INFO[331usize], entry),
                143usize => (&INFO[332usize], entry),
                144usize => (&INFO[333usize], entry),
                145usize => (&INFO[335usize], entry),
                146usize => (&INFO[336usize], entry),
                147usize => (&INFO[338usize], entry),
                148usize => (&INFO[339usize], entry),
                _ => unsafe { core::hint::unreachable_unchecked() },
            })
    }
    #[allow(dead_code)]
...
impl<R: Registry> event::Subscriber for Subscriber<R> {
    ...
    fn on_stream_control_packet_transmitted(
        ...
        self.measure(203usize, 93usize, event.packet_len);
        self.measure(204usize, 94usize, event.control_data_len);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_control_packet_received(
        ...
        self.measure(206usize, 95usize, event.packet_len);
        self.measure(207usize, 96usize, event.control_data_len);
        self.count_bool(208usize, 17usize, event.is_authenticated);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_endpoint_initialized(&self, meta: &api::EndpointMeta, event: &api::EndpointInitialized) {
        ...
        self.count_nominal(213usize, 7usize, &event.acceptor_addr);
        self.count_nominal(214usize, 8usize, &event.handshake_addr);
        self.count_bool(215usize, 18usize, event.tcp);
        self.count_bool(216usize, 19usize, event.udp);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_udp_immediate_transmission_scheduled(
        ...
        self.count_nominal(218usize, 9usize, &event.peer_address);
        self.measure(219usize, 97usize, event.buffer_size);
        self.measure(220usize, 98usize, event.segment_size);
        self.measure(221usize, 99usize, event.segment_count);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_udp_transmission_scheduled(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(222usize, 72usize, 1usize);
        self.count_nominal(223usize, 10usize, &event.peer_address);
        self.measure(224usize, 100usize, event.buffer_size);
        self.measure(225usize, 101usize, event.segment_size);
        self.measure(226usize, 102usize, event.segment_count);
        self.measure(227usize, 103usize, event.delay);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_udp_transmission_rejected(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(228usize, 73usize, 1usize);
        self.count_nominal(229usize, 11usize, &event.peer_address);
        self.measure(230usize, 104usize, event.buffer_size);
        self.measure(231usize, 105usize, event.segment_size);
        self.measure(232usize, 106usize, event.segment_count);
        self.measure(233usize, 107usize, event.delay);
        self.measure(234usize, 108usize, event.backoff);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_udp_packet_transmitted(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(235usize, 74usize, 1usize);
        self.count_nominal(236usize, 12usize, &event.peer_address);
        self.measure(237usize, 109usize, event.buffer_size);
        self.measure(238usize, 110usize, event.segment_size);
        self.measure(239usize, 111usize, event.segment_count);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_udp_transmit_errored(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(240usize, 75usize, 1usize);
        self.count_nominal(241usize, 13usize, &event.peer_address);
        self.measure(242usize, 112usize, event.buffer_size);
        self.measure(243usize, 113usize, event.segment_size);
        self.measure(244usize, 114usize, event.segment_count);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_udp_packet_received(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(245usize, 76usize, 1usize);
        self.count_nominal(246usize, 14usize, &event.peer_address);
        self.measure(247usize, 115usize, event.buffer_size);
        self.measure(248usize, 116usize, event.segment_size);
        self.measure(249usize, 117usize, event.segment_count);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    ...
    fn on_path_secret_map_initialized(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(251usize, 78usize, 1usize);
        self.measure(252usize, 118usize, event.capacity);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_uninitialized(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(253usize, 79usize, 1usize);
        self.measure(254usize, 119usize, event.capacity);
        self.measure(255usize, 120usize, event.entries);
        self.measure(256usize, 121usize, event.lifetime);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_background_handshake_requested(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(257usize, 80usize, 1usize);
        self.count_nominal(258usize, 15usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_entry_inserted(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(259usize, 81usize, 1usize);
        self.count_nominal(260usize, 16usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_entry_ready(
        ...
        self.count_nominal(262usize, 17usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_entry_replaced(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(263usize, 83usize, 1usize);
        self.count_nominal(264usize, 18usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_id_entry_evicted(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(265usize, 84usize, 1usize);
        self.count_nominal(266usize, 19usize, &event.peer_address);
        self.measure(267usize, 122usize, event.age);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_address_entry_evicted(
        ...
        self.count_nominal(269usize, 20usize, &event.peer_address);
        self.measure(270usize, 123usize, event.age);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_unknown_path_secret_packet_sent(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(271usize, 86usize, 1usize);
        self.count_nominal(272usize, 21usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_unknown_path_secret_packet_received(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(273usize, 87usize, 1usize);
        self.count_nominal(274usize, 22usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_unknown_path_secret_packet_accepted(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(275usize, 88usize, 1usize);
        self.count_nominal(276usize, 23usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_unknown_path_secret_packet_rejected(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(277usize, 89usize, 1usize);
        self.count_nominal(278usize, 24usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_unknown_path_secret_packet_dropped(
        ...
        self.count_nominal(280usize, 25usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_key_accepted(&self, meta: &api::EndpointMeta, event: &api::KeyAccepted) {
        #[allow(unused_imports)]
        use api::*;
        self.count(281usize, 91usize, 1usize);
        self.measure(282usize, 124usize, event.gap);
        self.measure(283usize, 125usize, event.forward_shift);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    ...
    fn on_replay_potentially_detected(
        ...
        self.measure(286usize, 126usize, event.gap);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_detected_packet_sent(
        ...
        self.count_nominal(288usize, 26usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_detected_packet_received(
        ...
        self.count_nominal(290usize, 27usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_detected_packet_accepted(
        ...
        self.count_nominal(292usize, 28usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_detected_packet_rejected(
        ...
        self.count_nominal(294usize, 29usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_detected_packet_dropped(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(295usize, 98usize, 1usize);
        self.count_nominal(296usize, 30usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_sent(&self, meta: &api::EndpointMeta, event: &api::StaleKeyPacketSent) {
        ...
        self.count_nominal(298usize, 31usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_received(
        ...
        self.count_nominal(300usize, 32usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_accepted(
        ...
        self.count_nominal(302usize, 33usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_rejected(
        ...
        self.count_nominal(304usize, 34usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_dropped(
        ...
        self.count_nominal(306usize, 35usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_address_cache_accessed(
        ...
        self.count_nominal(308usize, 36usize, &event.peer_address);
        self.count_bool(309usize, 20usize, event.hit);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_address_cache_accessed_hit(
        ...
        self.count_nominal(311usize, 37usize, &event.peer_address);
        self.measure(312usize, 127usize, event.age);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_id_cache_accessed(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(313usize, 106usize, 1usize);
        self.count_bool(314usize, 21usize, event.hit);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_id_cache_accessed_hit(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(315usize, 107usize, 1usize);
        self.measure(316usize, 128usize, event.age);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_cleaner_cycled(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(317usize, 108usize, 1usize);
        self.measure(318usize, 129usize, event.id_entries);
        self.measure(319usize, 130usize, event.id_entries_retired);
        self.measure(320usize, 131usize, event.id_entries_active);
        self.measure(321usize, 132usize, event.id_entries_active_utilization);
        self.measure(322usize, 133usize, event.id_entries_utilization);
        self.measure(323usize, 134usize, event.id_entries_initial_utilization);
        self.measure(324usize, 135usize, event.address_entries);
        self.measure(325usize, 136usize, event.address_entries_active);
        self.measure(326usize, 137usize, event.address_entries_active_utilization);
        self.measure(327usize, 138usize, event.address_entries_retired);
        self.measure(328usize, 139usize, event.address_entries_utilization);
        self.measure(
            329usize,
            140usize,
            event.address_entries_initial_utilization,
        );
        self.measure(330usize, 141usize, event.handshake_requests);
        self.measure(331usize, 142usize, event.handshake_requests_retired);
        self.measure(332usize, 143usize, event.handshake_lock_duration);
        self.measure(333usize, 144usize, event.duration);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_id_write_lock(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(334usize, 109usize, 1usize);
        self.measure(335usize, 145usize, event.acquire);
        self.measure(336usize, 146usize, event.duration);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_address_write_lock(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(337usize, 110usize, 1usize);
        self.measure(338usize, 147usize, event.acquire);
        self.measure(339usize, 148usize, event.duration);
        let _ = event;
        let _ = meta;
    }
}
